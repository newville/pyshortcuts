...
#html_title = None
html_title = 'PyShortcuts: create desktop shortcuts to python scripts on Windows, Mac, or Linux'

# A shorter title for the navigation bar.  Default is the uame as html_title.
html_short_title =  'PyShortcuts: create desktop shortcuts to python scripts'
...
htmlhelp_basename = 'pyshortcutsdoc'
...
latex_documents = [
  ('index', 'pyshortcuts.tex', u'Pyshortcuts documentation',
